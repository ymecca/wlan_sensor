...
def WLAN_PROCESS_IPERF():
	...
	### ICMP TIMES
        ...
        WLAN_DATA = {
                'WLAN_ID': WLAN_ID,
                'WLAN_TIME': WLAN_TIME,
                'WLAN_HARDWARE_MAC': WLAN_HARDWARE_MAC, #WLAN_DNS_UOL
                'WLAN_IPV4': WLAN_IPV4, 
		'WLAN_DNS_UOL': WLAN_DNS_UOL, 
		'WLAN_DNS_CISCO': WLAN_DNS_CISCO, 
		'WLAN_DNS_BBC': WLAN_DNS_BBC, 
		'WLAN_DNS_GOOGLE': WLAN_DNS_GOOGLE, 
		'WLAN_ICMP_UOL': WLAN_ICMP_UOL,
		'WLAN_ICMP_CISCO': WLAN_ICMP_CISCO, 
		'WLAN_ICMP_BBC': WLAN_ICMP_BBC, 
		'WLAN_ICMP_GOOGLE': WLAN_ICMP_GOOGLE, 
		'WLAN_HTTP_UOL': WLAN_HTTP_UOL,
		'WLAN_HTTP_CISCO': WLAN_HTTP_CISCO, 
		'WLAN_HTTP_BBC': WLAN_HTTP_BBC, 
		'WLAN_HTTP_GOOGLE': WLAN_HTTP_GOOGLE,
		'WLAN_DHCP_TIME': WLAN_DHCP_TIME,
		'WLAN_DHCP_STATUS': WLAN_DHCP_STATUS,
